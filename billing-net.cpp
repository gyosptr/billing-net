...
int main()
{
  ...
  int j, k, l, i, n, lama, hrg, sewa, cash, total, kembali, adm, atas, kode1, total3, bayar, kembali1;
  n = 2;
...
milih:
  ...
  tdkmilih:
    ...
    cout << "Total Biaya Sewa       : " << total << endl;
    cout << "------------------------------------" << endl;
    cout << "Jumlah Fasilitas DiSewa: " << jumlah;
    cout << " Kali" << endl;
